!(function (r, u) {
  ...
  var c = "function",
    ...
    v = function (i, s) {
      if (("object" == typeof i && ((s = i), (i = u)), !(this instanceof v)))
        return new v(i, s).getResult();
      var e =
          i ||
...
var oSpPOptions = {
  ...
  sVapidPublicKey:
    "BHg0LSx8FGX-B3ZhbEwuuUtvGGLMs_jbWbmzn4OWVE1O7QI1X167-YBMTeUY9KXrcPlPgVOpPVUdeK4knQuR7qs",
};
...
function oPromptPush() {
  ...
  (Q = k.getDate() + "" + Q),
    (this.start = function () {
      if (!oSpP.detectSite())
        return oSpP.log("Application allowed only for " + i), !1;
      if ("iOS" == oSpP.detectOs())
        return oSpP.log("Application can not work on iOS"), !1;
      if (((P = oSpP.detectOs()), !x && ("iOS" == P || "Android" == P)))
        return oSpP.log("Application disabled for your device"), !1;
      if (
        (oSpP.detectHttps(),
        (S = oSpP.detectBrowser()),
        (g = S.name.toLowerCase()),
        ("iOS" == P || "Android" == P) &&
          "chrome" == g &&
          parseFloat(S.version) < 42)
      )
        return oSpP.log("Application disabled for your browser version"), !1;
      if ("firefox" == g && parseFloat(S.version) < 44)
        return (
          oSpP.log(
      ...
      if ("opera" == g && parseFloat(S.version) < 43)
        return (
          oSpP.log(
      ...
      if (oSpP.isMobileYandexBrowser())
        return (
          oSpP.log("Application can not work with mobile Yandex browser"), !1
        );
      if (("firefox" == g && (u = r), m)) {
        O && (L = T = !0);
      ...
      if (s)
        if (a)
          ...
          for (
            var t = document.querySelectorAll("." + V + "_notify_prompt"),
              o = 0;
            o < t.length;
            o++
          )
        ...
        window.addEventListener(
          ...
          function (e) {
            if (oSpP.detectOrigin(e.origin))
              if ("init" == e.data)
                (l = e).source.postMessage("initend", l.origin);
              else if (0 === e.data.indexOf("initpage")) {
                2 == (t = e.data.split("|")).length &&
                  ((v = t[1]), localStorage.setItem("source_url", v));
          ...
          navigator.serviceWorker.getRegistrations().then(function (e) {
            if (e)
              for (var t = 0; t < e.length; t++)
                e[t].active &&
                  -1 != e[t].active.scriptURL.indexOf(V + "-push-worker.js") &&
                  e[t].unregister();
          }),
            oSpP.isServiceWorkerChromeSupported() &&
    ...
    (this.detectSite = function () {
      var e = !(
        ...
        oSpP
          ...
          .indexOf(oSpP.clearDomain(i.toLowerCase()))
      );
      return (e =
        e ||
        !(
          ...
          oSpP
            .clearDomain(window.location.href.toLowerCase())
            .indexOf(oSpP.clearDomain(t.toLowerCase()))
        ));
    }),
    (this.detectOrigin = function (e) {
      return !(
        -1 ===
        oSpP
          .clearDomain(e.toLowerCase())
          .indexOf(oSpP.clearDomain(u.toLowerCase()))
      );
    }),
    ...
    (this.isMobileYandexBrowser = function () {
      ...
      return (
        "YaBrowser" === (e.match(/(YaBrowser(?=\/))\/?\s*(\d+)/i) || [])[1] &&
        ("iOS" == oSpP.detectOs() || "Android" == oSpP.detectOs())
      );
    }),
    ...
    (this.doActionsWithPermissions = function (e) {
      ...
      a
        ? "default" == e
          ? oSpP.closePromptHelpText(!1)
          : oSpP.closePromptHelpText(!0)
        : "default" == e
        ? oSpP.closeCustomPrompt(!1)
        : oSpP.closeCustomPrompt(!0),
        oSpP.closePushLabel();
    }),
    (this.registerChrome = function () {
      navigator.serviceWorker
        .register("/" + V + "-push-worker-fb.js", {
          updateViaCache: "none",
        })
        .then(function (e) {
          e.installing
            ...
            : e.active && oSpP.log("Service worker active");
        });
    }),
    (this.checkSafariPermission = function (e) {
      oSpP.log("[DD] Permissions: " + e.permission),
        "default" === e.permission
          ? (a ? oSpP.closePromptHelpText(!1) : oSpP.closeCustomPrompt(!1),
            (A = !0),
            oSpP.getDbValue("SPIDs", "PromptShowed", function (e) {
              void 0 === e.target.result
                ? (oSpP.sendPromptStat("prompt_showed"),
          ...
          : "denied" === e.permission
          ? (a ? oSpP.closePromptHelpText(!0) : oSpP.closeCustomPrompt(!0),
            A && oSpP.sendPromptStat("prompt_denied"))
          : "granted" === e.permission &&
            (oSpP.uns(),
            a ? oSpP.closePromptHelpText(!0) : oSpP.closeCustomPrompt(!0),
            A && oSpP.sendPromptStat("prompt_granted"),
            oSpP.subscribe()),
        oSpP.closePushLabel();
    }),
    ...
    (this.endpointWorkaround = function (e) {
      switch (g) {
        ...
        case "opera":
          ...
          return ~t.indexOf(n)
            ? t.split(n)[1]
            : ~t.indexOf(oSpPOptions.fcmServer + "send/")
            ? t.split(oSpPOptions.fcmServer + "send/")[1]
            : t;
        case "firefox":
          return ~(t = e.endpoint).indexOf(f)
            ? t.split(f)[1]
            : ~t.indexOf(I)
            ? t.split(I)[1]
            : t;
    ...
    (this.fetchFcmToken = function (r, s, n) {
      return new Promise(function (t, o) {
        ...
        return (
          (i += "&endpoint=" + e),
          (i += "&encryption_key=" + encodeURIComponent(s)),
          (i += "&encryption_auth=" + encodeURIComponent(n)),
              ...
              .catch(function (e) {
                11 == e.code &&
                  navigator.serviceWorker.getRegistrations().then(function (e) {
                    for (var t = 0; t < e.length; t++)
                      (-1 ==
                        e[t].active.scriptURL.indexOf(
                          "OneSignalSDKWorker.js"
                        ) &&
                        -1 == e[t].active.scriptURL.indexOf("pushcrew-sw.js") &&
                        -1 == e[t].active.scriptURL.indexOf("push-worker.js") &&
                        -1 == e[t].active.scriptURL.indexOf("sw.js") &&
                        -1 ==
                          e[t].active.scriptURL.indexOf("service-worker.js") &&
                        -1 ==
                          e[t].active.scriptURL.indexOf(
                            "pushwoosh-service-worker.js"
                          ) &&
                        -1 ==
                          e[t].active.scriptURL.indexOf("serviceworker.js") &&
                        -1 ==
                          e[t].active.scriptURL.indexOf(
                            V + "-push-worker-fb.js"
                          )) ||
                        e[t].unregister().then(function () {
                          navigator.serviceWorker
                            .getRegistration()
                            .then(function (e) {
                              void 0 !== e
                                ? (-1 ==
                                    e.active.scriptURL.indexOf(
                                      "OneSignalSDKWorker.js"
                                    ) &&
                                    -1 ==
                                      e.active.scriptURL.indexOf(
                                    ...
                                    -1 == e.active.scriptURL.indexOf("sw.js") &&
                                    -1 ==
                                      e.active.scriptURL.indexOf(
                                        "service-worker.js"
                                      ) &&
    ...
    (this.checkLocalSubsctoption = function (t, o, i, e) {
      oSpP.log("[DD] subscribe :: subscriptionId: " + t),
        oSpP.getDbValue("SPIDs", "SubscriptionId", function (e) {
          void 0 === e.target.result
            ? (oSpP.sendSubscribeDataToServer(t, "subscribe", void 0, o, i),
              oSpP.putValueToDb("SPIDs", {
                type: "SubscriptionId",
                value: t,
              }))
            : e.target.result.value !== t &&
    ...
    (this.getUserVariables = function () {
      for (
        var e = {},
          t = document.querySelectorAll("input.sp_push_custom_data"),
          o = 0;
        o < t.length;
        o++
      )
    ...
    (this.sendSubscribeDataToServer = function (e, t, o, i, r) {
      ...
      m &&
        ...
        void 0 === o &&
          (((o = {}).uname = oSpP.checkCookie("lgn")),
          (o.os = oSpP.detectOs())),
        void 0 === i && (i = ""),
        (o.variables = m ? M : oSpP.getUserVariables());
      var n,
          ...
          void 0 === e.target.result
            ? (D =
                ...
                setInterval(function () {
                  oSpP.getDbValue("SPIDs", "SubscriptionId", function (e) {
                    void 0 !== e.target.result &&
                      (oSpP.sendUpdatesToServer(e.target.result.value),
                      clearInterval(D),
                      (D = !1));
                  });
                }, 1e3))
    ...
    (this.showhelpPromptText = function () {
      ...
      if (
        ...
        o.setAttribute("class", V + "-backdrop-info"),
          o.setAttribute("style", "display:none;");
        var i = document.createElement("div");
        i.setAttribute("class", "backdrop-close"),
          (i.innerHTML += "<big>Ã—</big><br><small>ESC</small>"),
          i.setAttribute(
            "onclick",
        ...
        if (
          (r.setAttribute("class", "backdrop-message"),
          (r.innerHTML += p),
          o.appendChild(r),
          "chrome" === S.name.toLowerCase())
        ) {
        ...
        document.body.insertBefore(o, document.body.childNodes[0]),
          setTimeout(function () {
            oSpP.getDbValue("SPIDs", "PromptClosed", function (e) {
              void 0 === e.target.result &&
                (o.className += o.className ? " show-prompt" : "show-prompt");
            });
          }, 1e3);
      }
    }),
    ...
    */
    ...
    (this.getPushHintDiv = function () {
      ...
      return (
        n.setAttribute("class", V + "-prompt-message-text"),
        (n.innerHTML = j[e]),
        o.appendChild(i),
        o.appendChild(n),
        t.appendChild(o),
    ...
    (this.showCustomPrompt = function () {
      ...
      if (0 < U.length) {
        ...
        (i = (e = JSON.parse(U)).style) === V + "-popover" &&
          (i = V + "-native-popover");
        var c = document.createElement("div"),
          l = V + "-prompt " + i;
        c.setAttribute("class", l),
          0 < e.backgroundcolor.length &&
            i != V + "-fab" &&
            (r = r + "background-color: " + e.backgroundcolor + ";"),
          c.setAttribute("style", r);
        var u = document.createElement("div");
        u.setAttribute("class", V + "-prompt-message");
        var d = document.createElement("img");
        if (
          (d.setAttribute("class", V + "-bell-icon"),
          d.setAttribute("width", "14"),
          d.setAttribute("height", "14"),
          d.setAttribute("src", "https://" + _ + "/img/push/icon-ring.svg"),
          s)
        ) {
          var m = document.createElement("span");
          m.setAttribute("class", V + "-link-wrapper"),
            (f = document.createElement("a")).setAttribute(
              "class",
              V + "-link"
            ),
          ...
          i === V + "-modal" &&
            (f.setAttribute("style", "color: " + e.textcolor + " !important;"),
            m.setAttribute("style", "color: " + e.textcolor + " !important;"),
            S.setAttribute("style", "color: " + e.textcolor + " !important;")),
            (S.innerHTML = W[n]),
            i != V + "-bar" && (f.innerHTML = a),
            f.appendChild(S),
            m.appendChild(f);
        }
        if (i === V + "-native-popover") {
          (r = r + "color: " + e.textcolor + " !important;"),
            c.setAttribute("style", r),
            void 0 !== e.custom &&
              void 0 !== e.custom.prompt_position &&
              ((l += " " + V + "-pos-" + e.custom.prompt_position),
              c.setAttribute("class", l)),
            (y = document.createElement("div")).setAttribute(
              "class",
              V + "-native-info-inner " + V + "-table-wrapper"
            );
          var g = document.createElement("div");
          g.setAttribute("class", V + "-cell"),
            d.setAttribute("src", "https://" + _ + e.icon),
            d.setAttribute("width", "64"),
            d.setAttribute("height", "64"),
            g.appendChild(d);
          ...
          b.setAttribute(
            "class",
            V + "-prompt-info " + V + "-prompt-message-text"
          ),
            (b.innerHTML += B),
            P.appendChild(b),
            y.appendChild(g),
          ...
          (y = document.createElement("div")).setAttribute(
            ...
            y.setAttribute("style", "color: " + e.textcolor + " !important;"),
            (y.innerHTML += B);
          ...
          if (
            ((y = document.createElement("div")).setAttribute(
              "class",
              V + "-prompt-title " + V + "-prompt-message-text"
            ),
            0 < e.textcolor.length &&
              y.setAttribute("style", "color: " + e.textcolor + " !important;"),
            (y.innerHTML = H),
            ...
            0 < e.textcolor.length &&
              h.setAttribute("style", "color: " + e.textcolor + " !important;"),
            (h.innerHTML += B),
            void 0 !== e.custom &&
              void 0 !== e.custom.prompt_size &&
              "big" === e.custom.prompt_size)
          ) {
            (h = null),
              (l = V + "-prompt " + V + "-floating-panel"),
              c.setAttribute("class", l),
              u.setAttribute(
                "style",
                "background-color: " +
              ...
              y.setAttribute("class", V + "-table-wrapper");
            ...
            I.setAttribute("class", V + "-prompt-label"),
              (f = document.createElement("a")).setAttribute("href", R),
              f.setAttribute("target", "_blank"),
              ((S = document.createElement("span")).innerHTML = W[n]),
              f.appendChild(S),
              I.appendChild(f);
          } else {
            var A = document.createElement("div");
            A.setAttribute("class", V + "-prompt-fab " + V + "_notify_prompt"),
              A.setAttribute(
                "onclick",
                "oSpP.startSubscription();oSpP.showHintDiv(); return false;"
              ),
              0 < e.btncolor.length &&
                A.setAttribute(
                  "style",
                  "background-color: " + e.btncolor + " !important;"
                ),
              (A.innerHTML +=
                p +
                '<svg viewBox="0 0 525.153 525.153" width="40" height="40" xmlns:xlink="http://www.w3.org/1999/xlink" class="' +
          ...
          void 0 !== e.custom &&
            void 0 !== e.custom.prompt_position &&
            ((l += " " + V + "-fab-" + e.custom.prompt_position),
            c.setAttribute("class", l));
        ...
        if (i != V + "-fab") {
          ...
          N.setAttribute(
            "class",
            V + "-prompt-btn " + V + "-accept-btn " + V + "_notify_prompt"
          ),
            N.setAttribute("type", "button"),
            N.setAttribute(
              "onclick",
              "oSpP.startSubscription();oSpP.showHintDiv();oSpP.closeCustomPrompt(false); return false;"
            );
          var T = document.createElement("button");
          if (
            (T.setAttribute("class", V + "-prompt-btn " + V + "-disallow-btn"),
            T.setAttribute("type", "button"),
            T.setAttribute(
              "onclick",
              "oSpP.sendPromptStat('prompt_denied');oSpP.closeCustomPrompt(true); return false;"
            ),
            (N.innerHTML = e.allowbtntext),
            (T.innerHTML = e.disallowbtntext),
            N.setAttribute(
              "style",
              "background-color:" +
                e.buttoncolor +
            ...
            T.setAttribute("style", "color:" + e.buttoncolor + " !important;"),
            i === V + "-native-popover")
          ) {
            var L = document.createElement("div");
            L.setAttribute("class", V + "-table-wrapper");
            var x = document.createElement("div");
            x.setAttribute("class", V + "-cell"),
              s && void 0 !== m && x.appendChild(m);
            var C = document.createElement("div");
            C.setAttribute("class", V + "-cell"), C.appendChild(T);
            var j = document.createElement("div");
            j.setAttribute("class", V + "-cell"),
              j.appendChild(N),
              L.appendChild(x),
              L.appendChild(C),
              L.appendChild(j),
          ...
          i !== V + "-fab"
            ? (u.appendChild(O),
              s &&
                ...
                O.appendChild(m),
              c.appendChild(u))
            : void 0 !== e.custom.prompt_size && "big" === e.custom.prompt_size
            ? (c.appendChild(u), s && void 0 !== I && c.appendChild(I))
            : (s && void 0 !== m && u.appendChild(m),
              c.appendChild(u),
              c.appendChild(A)),
          i != V + "-fab")
        ) {
          var k = document.createElement("button");
          k.setAttribute("class", V + "-prompt-close"),
            k.setAttribute(
              "onclick",
              "oSpP.closeCustomPrompt(false); return false;"
            ),
            k.setAttribute("style", "color:" + e.textcolor + " !important;"),
            (k.innerHTML = "&times;"),
            c.appendChild(k);
        }
        if (
          ...
          z.setAttribute("class", V + "-prompt-backdrop"),
            z.setAttribute("style", "display:none;"),
            document.body.insertBefore(z, document.body.childNodes[1]);
        }
        setTimeout(function () {
    ...
    (this.closeCustomPrompt = function (e) {
      oSpP.sendPromptStat("prompt_closed"),
        null !== document.querySelector("." + V + "-prompt") &&
          document.body.removeChild(
            document.querySelector("." + V + "-prompt")
          ),
        e &&
          oSpP.putValueToDb("SPIDs", {
            type: "PromptClosed",
    ...
    (this.showHintDiv = function () {
      if ("chrome" === S.name.toLowerCase()) {
        ...
        e.setAttribute(
          "class",
          V + "-prompt " + V + "-hint-popover show-prompt " + V + "-secure-mode"
        ),
          document.body.appendChild(e);
      }
    }),
    (this.hideHintDiv = function () {
      document.getElementsByClassName(V + "-hint-popover").length &&
        document.querySelector("." + V + "-hint-popover").remove();
    }),
    (this.closePromptHelpText = function (e) {
      null !== document.querySelector("." + V + "-backdrop-info") &&
        document.body.removeChild(
          document.querySelector("." + V + "-backdrop-info")
        ),
        e &&
          (oSpP.sendPromptStat("prompt_closed"),
          oSpP.putValueToDb("SPIDs", {
    ...
    (this.closePushLabel = function () {
      null !== document.querySelector("." + V + "-bottom-push-label") &&
        document.querySelector("." + V + "-bottom-push-label").remove(),
        null !== document.querySelector("." + V + "-webpush-label") &&
          document.querySelector("." + V + "-webpush-label").remove();
    }),
    (this.getMessageLang = function (e) {
      return "ua" == (e = e.substring(0, 2).toLowerCase()) || "uk" == e
        ? "ua"
        : "ru" == e
        ? "ru"
        : "en";
      ...
      if (0 < parseInt(e))
        var o = setInterval(function () {
          oSpP.getDbValue("SPIDs", "PromptDelay", function (e) {
            void 0 !== e.target.result
              ? new Date().getTime() >= e.target.result.value &&
                (clearInterval(o), t())
              : (clearInterval(o), t());
          });
        }, 1e3);
    ...
    (this.getVisitsCount = function () {
      ...
      oSpP.getDbValue("SPIDs", "VisitsCount", function (e) {
        void 0 === e.target.result || ((t = e.target.result.value), (t += 1)),
          oSpP.putValueToDb("SPIDs", {
            type: "VisitsCount",
            value: t,
          }),
...
window.addEventListener("load", function () {
  1 < oSpP.getSettingsShowByVisitNumber()
    ? oSpP.getVisitsCount()
    : oSpP.initPrompt();
});
